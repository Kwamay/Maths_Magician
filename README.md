...
**MATH MAGICIANS** is a project to do math calculations  after they visit the web app.
...
```sh
  cd my-folder
  git clone git@github.com:Kwamay/Maths_Magician.git
```
...
Feel free to check the [issues page](https://github.com/Kwamay/Maths_Magician/issues).
